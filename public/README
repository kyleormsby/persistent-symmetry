...
5. [5_alternative_embeddings_distances.ipynb](https://github.com/kyleormsby/persistent-symmetry/blob/main/public/5_alternative_embeddings_distances.ipynb) covers several methods we used to try to fix where the algorithm breaks down 
...
A2. [A2_determining_point_group.ipynb](https://github.com/kyleormsby/persistent-symmetry/blob/main/public/A2_determining_point_group.ipynb) similarity demonstrates that other, less-involved algorithms that do not rely on persistent homology can be used to detect rotational symmetry in images
